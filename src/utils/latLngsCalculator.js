...
function calcCenter(coordinates) {
    ...
    switch (coordinates.length) {
        case 1:
            ...
            break;
        case 2:
            const lng = (coordinates[0][0] + coordinates[1][0]) * 0.5;
            const lat = (coordinates[0][1] + coordinates[1][1]) * 0.5;
            center = [lng, lat];
            break;
        default:
            ...
            const { coordinates: point } = centerFeature.geometry;
            center = point;
            break;
    }
    return center;
